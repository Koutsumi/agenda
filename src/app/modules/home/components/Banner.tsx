    ...
    return(
       <section className="w-full flex flex-col items-center justify-center bg-primary">
            <div className="w-[90%] md:w-[35%] flex flex-col items-center justify-center my-[4em]">
                ...
                <a href="" className="bg-secondary py-2 px-4 rounded-lg mt-4 hover:bg-white hover:text-secondary hover:border-2 border-2 hover:border-secondary border-secondary"><button>Agendar demonstração</button></a>
            </div>
       </section>
    )
}